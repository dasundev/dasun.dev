...
<div>
    <h1 class="text-zinc-100 text-4xl md:text-5xl font-bold tracking-tight leading-normal mt-8">{{ $this->post->title }}</h1>
    @if($this->post->isPublished())
        <div class="flex flex-col sm:flex-row items-start sm:items-center gap-1 sm:gap-2 mt-4">
    ...
    @endif
    <article class="markdown mt-10 flex max-w-full flex-col prose prose-invert">
