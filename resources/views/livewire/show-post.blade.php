...
<div class="max-w-3xl mx-auto">
    <article class="max-w-none my-10 px-5 lg:px-0">
        ...
        <p class="text-sm text-gray-700 dark:text-gray-200 mt-5 mb-10">
            Published on
        ...
        <div class="mt-10 flex justify-center gap-2 bg-gray-50 dark:bg-gray-900 p-5">
            ...
            <a href="https://x.com/dasundev" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 512 512" class="w-6 h-6 text-black dark:text-gray-300">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z" />
                </svg>
            </a>
            <a href="https://github.com/dasundev" target="_blank">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 496 512" class="w-6 h-6 text-black dark:text-gray-300">
                    <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                    <path
