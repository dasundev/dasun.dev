<div class="max-w-3xl mx-auto my-10">
    ...
    @foreach ($posts as $post)
        <div class="py-10 px-5 lg:px-10 mb-8 transition-none lg:transition transform-none lg:transform border border-gray-100 dark:border-gray-900 hover:scale-100 lg:hover:scale-105 hover:border-gray-200 dark:hover:border-gray-800 motion-reduce:transition-none motion-reduce:hover:transform-none">
